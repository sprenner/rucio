...
create_and_move_dataset = function(scope, name, dids) {
    ...
    if(storage.isSet('moving_datasets') && found_dataset_list.length > 0) {     
                                            ...
                                            success: function(data) {
                                                ...
                                                r.attach_dids({
                                                    ...
                                                    success: function(data2) {
                                                        ...
                                                        move_did(scope, name + '.' + found_dataset_list[0]['timestamp'], true, dids.length, 0);
                                                    },
                                                    error: function(jqXHR, textStatus, errorThrown) {
                                                        console.log(jqXHR);
        ...
        // TODO: Let storage expire? Otherwise evergrowing list of datasets. Idea: Throw out Datasets older than X, via timestamp
        r.add_did({
            'scope': scope,
            'name': name + '.' + ts,
            'type': 'DATASET',
            ...
            success: function(data) {
                r.attach_dids({
                    ...
                    success: function(data2) {
                        console.log(data2);                      
                        move_did(scope, name + '.' + ts, true, dids.length, 0);
                    },
                    error: function(jqXHR, textStatus, errorThrown) {
                        console.log(jqXHR);
                        alert('An error has ocurred.');
