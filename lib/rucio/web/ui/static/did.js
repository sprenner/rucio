                            ...
                            if (state == 'AVAILABLE') {
                                ...
                                try{
                                    if (browser_enabled_rses.indexOf(rse) != -1 && !blacklisted){ 
                                        ...
                                        str_rses += rse + " <a href=\"#\" onclick=\"move_did('" + replica['scope'] + "','" + replica['name'] + "',false,1,1);return false;\" style=\"color: rgb(0,255,0)\"><i class=\"fi-download size-18\"></i></a>";
			                        }
		                        } catch (err) {
...
move_did = function(scope, name, is_dataset, no_of_files, attempt_no) {
    ...
    console.log(scope + ' ' + name + ' ' + is_dataset + ' ' + no_of_files + ' ' + attempt_no);
    var options = {
                                        ...
                                        success: function(data) {
                                            ...
                                            r.attach_dids({
                                                ...
                                                success: function(data2) {
                                                    ...
                                                    move_did(scope, name + '.' + found_dataset_list[0]['timestamp'], true, dids.length, 1);
                                                },
                                                error: function(jqXHR, textStatus, errorThrown) {
                                                    console.log(jqXHR);
        ...
        r.add_did({
            ...
            success: function(data) {
                ...
                r.attach_dids({
                    ...
                    success: function(data2) {
                        console.log(data2);                      
                        move_did(scope, name + '.' + ts, true, dids.length, 1); //TODO: TESTTEST
                    },
                    error: function(jqXHR, textStatus, errorThrown) {
                        console.log(jqXHR);
                        removeDatasetFromStorage(scope, name);
