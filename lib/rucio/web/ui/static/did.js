                ...
                r.list_replicas({
                    ...
                    success: function(ret) {
                        ...
                        if(move_amount == 0) {
                            ...
                            move_success = create_and_move_dataset('user.' + r.account, name + '.' + storage.get('move_timer'), files_to_move);
                            if(move_success) { 
                                alert(move_amount + ' files in this dataset have to be moved to WebDAV enabled RSEs first, please come back later.');                            
